...
import edu.umd.lib.dspace.authenticate.impl.LdapServiceImpl.LdapServerDelegate;
...
public class LdapServiceImplTest extends AbstractUnitTest {
    ...
    public void ldapCacheMissesOnFirstUse() throws Exception {
        ...
        verify(delegate, times(1)).queryLdapService(any());
    }
    ...
    class TestableLdapServiceImpl extends LdapServiceImpl {
        ...
        @Override
        protected LdapServerDelegate makeLdapServerDelegate(org.dspace.core.Context context) throws NamingException {
            return mock(LdapServiceImpl.LdapServerDelegate.class);
        }

        public LdapServerDelegate getDelegate() {
