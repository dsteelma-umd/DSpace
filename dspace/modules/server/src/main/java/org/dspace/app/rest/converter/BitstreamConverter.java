...
public class BitstreamConverter extends DSpaceObjectConverter<Bitstream, BitstreamRest> {
    ...
    public BitstreamRest convert(org.dspace.content.Bitstream obj, Projection projection) {
        ...
        // UMD Customization
        b.setRestrictedAccess(getRestrictedAccess(obj));
    ...
    // Methods to support retrieving ETD embargo and checking validity of
    // ETD embargo
     ...
     * </ul>
     *
     * @param object the DSpaceObject to get the access restriction of. Should
     * not be null.
     */
    protected String getRestrictedAccess(DSpaceObject object) {
