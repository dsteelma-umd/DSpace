...
public class BitstreamConverter extends DSpaceObjectConverter<Bitstream, BitstreamRest> {
    ...
    protected EmbargoDTOService embargoDTOService;
    ...
    public BitstreamRest convert(org.dspace.content.Bitstream obj, Projection projection) {
        ...
        // UMD Customization
        boolean restrictedAccess = isRestrictedAccess(obj);
        b.setRestrictedAccess(restrictedAccess);
        // End UMD Customization
    ...
    // UMD Customization
    /**
     * Returns true if the given Bitstream has restricted access (i.e.,
     * is embargoed), false otherwise.
     *
     * @param bitstream the Bitstream to test
     * @return true if the given Bitstream is has restricted access,
     * false otherwise.
     */
    public boolean isRestrictedAccess(Bitstream bitstream) {
        return embargoDTOService.isEmbargoed(bitstream);
    }
    // End UMD Customization
}
