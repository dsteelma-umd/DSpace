...
public class BitstreamRest extends DSpaceObjectRest {
    ...
    /**
     * A String representing whether (and how long) this bitstream has
     * restricted access.
     */
     ...
     * DSpace object has restricted access:
     *
     * <ul>
     * <li> A date string (in "yyyy-MM-dd" format) - The lift date of the restriction
     * <li> "FOREVER" - the access restriction is forever
     * <li> "NONE" - there is no access restriction
     * </ul>
     *
     * @return a String indicating whether (and how long) this bitstream has
     * restricted access.
     */
    ...
    /**
     * Sets whether (and how long) this bitstream has access restrictions.
     *
     * @param restrictedAccess the String indicating the access restriction,
     * if any.
     */
