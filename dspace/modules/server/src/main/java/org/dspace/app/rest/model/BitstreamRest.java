...
public class BitstreamRest extends DSpaceObjectRest {
    ...
    // UMD Customization
    // True if bitstream has restricted access (i.e., is embargoed), false otherwise.
    ...
    // UMD Customization
    /**
     * Returns true if the bitstream is embargoed, false otherwise.
     *
     * @return true if the bitstream is embargoed, false otherwise.
     */
    ...
    /**
     * Sets whether this bitstream is embargoed
     *
     * @param restrictedAccess true if bitstream is embargoed, false otherwise.
     */
